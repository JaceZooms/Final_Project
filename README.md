...
to use the app, click the load CSV button at the top left, and then click upload, and calculate. Then you must mess with the degree and smoother settings till both the graphs they produce fit the data to your liking. 
